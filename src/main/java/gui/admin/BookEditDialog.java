...
/**
 * 新增/修改书籍信息的对话框 (重构版)
 * 使用 entity.library.Book 和 entity.library.Category。
 */
public class BookEditDialog extends JDialog {
    ...
    public BookEditDialog(Frame parent, IBookClientSrv bookSrv, Book bookToEdit) {
        super(parent, true);
    ...
    private void loadCategories() {
        try {
            List<Category> categories = bookSrv.getAllCategories();
