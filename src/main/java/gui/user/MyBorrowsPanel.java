...
public class MyBorrowsPanel extends JPanel {
    ...
    public MyBorrowsPanel(User user, IUserClientSrv userSrv) {
    ...
    public void refreshData() {
        ...
        new SwingWorker<List<BorrowRecordView>, Void>() {
            ...
            protected List<BorrowRecordView> doInBackground() throws Exception {
                // 使用 String 类型的用户ID
                return userSrv.getMyBorrowRecords(currentUser.getId());
            }
            ...
            protected void done() {
                try {
                    ...
                    JOptionPane.showMessageDialog(MyBorrowsPanel.this, "加载借阅记录失败: " + e.getMessage(), "错误", JOptionPane.ERROR_MESSAGE);
                } finally {
    ...
    class ActionPanelEditor extends AbstractCellEditor implements TableCellEditor {
        ...
        private void handleReturnAction() {
            new SwingWorker<String, Void>() {
                @Override protected String doInBackground() throws Exception {
                    return userSrv.returnBook(currentRecord.getCopyId());
                }
        ...
        private void handleRenewAction() {
            new SwingWorker<String, Void>() {
                @Override protected String doInBackground() throws Exception {
                    return userSrv.renewBook(currentRecord.getRecordId());
                }
                @Override protected void done() {
                    try {
                        String result = get();
