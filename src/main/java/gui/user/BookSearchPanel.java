...
public class BookSearchPanel extends JPanel {
    ...
    public BookSearchPanel(User user, IUserClientSrv userSrv, IBookClientSrv bookSrv) {
    ...
    private void performSearch() {
        ...
        new SwingWorker<List<Book>, Void>() {
            ...
            protected List<Book> doInBackground() throws Exception {
                return bookSrv.searchBooks(title, author, publisher, categoryId);
            }
                ...
                new SwingWorker<String, Void>() {
                    ...
                    protected String doInBackground() throws Exception {
                        if ("借 阅".equals(actionType)) {
                            return userSrv.borrowBook(currentUser.getId(), book.getBookId());
                        } else {
                            return userSrv.reserveBook(currentUser.getId(), book.getBookId());
                        }
                    }
